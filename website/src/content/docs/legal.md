...
state what dbSaci is compatible with. Descriptive (nominative) use like this does
...
- Compatibility is derived from the observable wire protocol and public
  documentation.
- This is not legal advice. Anyone shipping dbSaci in a product or company should
