...
fn oracle_error_for_pos(error: &Error) -> (u32, String, u16) {
    ...
    let code = match sqlstate {
        ...
        "23000" if lower.contains("duplicate") => 1, // MariaDB unique key
        "23000" if lower.contains("foreign key") => 2291, // MariaDB parent key
        "23000" if lower.contains("cannot be null") => 1400, // MariaDB NOT NULL
        ...
        "42000" if lower.contains("column count doesn't match") => 947,
        "42000" if lower.contains("ambiguous") => 918,
        "42000" if lower.contains("regex error") => 12726,
