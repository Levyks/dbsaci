# Result-set delivery. PgSaci pulls rows out of PostgreSQL incrementally (the
...
# fetches pull the remaining rows without buffering the whole result in PgSaci.
...
# repeated Fetch without PgSaci buffering the whole result and without a single
# oversized packet.
