...
Or run it from a container (`levyks/pgsaci:0.0.3`, ~10 MB) —
`docker run -p 1521:1521 -e PGSACI_PG_HOST=… levyks/pgsaci:0.0.3`. See the
...
(`levyks/pgsaci:0.0.3`, a static musl build). Both database containers get
